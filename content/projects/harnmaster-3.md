---
title: HârnMaster 3
description: Game system definition of the HârnMaster 3 RPG for Foundry VTT.
aliases:
  - /projects/hm3/
---

This is a game system definition of the HârnMaster 3 RPG for [Foundry Virtual Tabletop](http://foundryvtt.com/).

### HârnMaster Copyright Notice

This is an unofficial HârnFanon work. It is a derivative work from material created by N. Robin Crossby and is released for free distribution and personal use without the permission or endorsement of N. Robin Crossby or his estate.

Hârn, HârnMaster, and HârnWorld are all © 1987-2020 N. Robin Crossby and Columbia Games Inc. Their works are available for sale on the [Columbia Games Ltd website](http://columbiagames.com/harn/).
...
There are a number of modules that extend the HârnMaster system by providing new functionality or ready-made content for you to use in your campaign. See the [Modules](https://github.com/toastygm/HarnMaster-3-FoundryVTT/wiki/Modules) page for more information.
...
Although most parts of this system should be self-explanatory to those familiar with HârnMaster 3, there are some peculiarities that will be described here.

## Missing Components of HârnMaster Rules

This system requires the user to have a copy of the HârnMaster rules in order to play effectively. Skill descriptions and rules descriptions have been intentionally left out. This system is not intended to be used as a character generator; for that you will need a copy of the HârnMaster rules.

## Actors Supported

The following actors are supported:

- **Character:** A standard humanoid character, such as a Human, Khuzdul, or Sindarin. This can also be used for other humanoid creatures, such as Gargun. A character has the following features:
  1. Ability Scores
...
- **Creature:** Any being not a "character" (e.g., animals, Ivashu, etc.). A creature has the following features:
...
- **Container:** A token (such as a chest, a wagon, or a shop) that can contain items and can be placed separately on the canvas.
